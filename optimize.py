...
parser.add_argument("--modelname", type=str, default="resnet", 
                    choices=['randomforest', 'xgboost', 'catboost', 'lightgbm', 'mlp', 'embedmlp', 'mlpplr', 'ftt', 'resnet', 't2gformer', 'saint', 'modernnca', 'tabr', 'tabm']) #lr, tabpfn not here -- only in reproduce.py; ptarl은 libs/ptarl.py 삭제로 제외
